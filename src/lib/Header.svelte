...
<div class="flex mt-5 justify-between">
    <div style="clip-path: polygon(0% 0%, calc(100% - 2em) 0%, 100% 100%, 0% 100%);" on:introstart={() => firstUpdate = true} transition:fly={{ duration:1000, x: "-66.67vw", opacity: 1, easing: cubicOut }} 
        class="h-[3em] max-h-[3em] text-black bg-evyellow w-full md:w-2/3 transition-all duration-1000">
        <div class="items-center text-center text-black font-semibold text-xl w-full h-full flex md:hidden justify-evenly">
